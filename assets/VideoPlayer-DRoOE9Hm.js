...
`)}`}function K(e=0){return new Promise(t=>setTimeout(t,e))}function Dt(e,t){let n;return function(...r){const o=()=>(n=null,e.apply(this,r));clearTimeout(n),n=setTimeout(o,t)}}function Nt(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}const se=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:Pt,addClass:w,append:g,assToVtt:Vt,capitalize:ht,clamp:_,createElement:S,debounce:Dt,def:v,download:Rt,errorHandle:V,escape:At,get:_t,getComposedPath:yt,getExt:nt,getIcon:Mt,getRect:Y,getStyle:re,has:et,hasClass:H,includeFromEvent:q,inverseClass:N,isBrowser:ct,isIOS:Et,isIOS13:Ct,isInViewport:gt,isMobile:M,isSafari:Tt,loadImg:It,mergeDeep:ut,query:A,queryAll:ot,remove:dt,removeClass:I,replaceElement:vt,secondToTime:F,setStyle:p,setStyleText:St,setStyles:pt,siblings:Lt,sleep:K,srtToVtt:Ot,supportsFlex:zt,throttle:Nt,tooltip:B,unescape:oe,userAgent:rt,vttToBlob:st},Symbol.toStringTag,{value:"Module"})),wt="array",E="boolean",P="string",D="number",U="object",W="function";function Yt(e,t,n){return V(t===P||t===D||e instanceof Element,`${n.join(".")} require '${P}' or 'Element' type`)}const Z={html:Yt,disable:`?${E}`,name:`?${P}`,index:`?${D}`,style:`?${U}`,click:`?${W}`,mounted:`?${W}`,tooltip:`?${P}|${D}`,width:`?${D}`,selector:`?${wt}`,onSelect:`?${W}`,switch:`?${E}`,onSwitch:`?${W}`,range:`?${wt}`,onRange:`?${W}`,onChange:`?${W}`},ft={id:P,container:Yt,url:P,poster:P,type:P,theme:P,lang:P,volume:D,isLive:E,muted:E,autoplay:E,autoSize:E,autoMini:E,loop:E,flip:E,playbackRate:E,aspectRatio:E,screenshot:E,setting:E,hotkey:E,pip:E,mutex:E,backdrop:E,fullscreen:E,fullscreenWeb:E,subtitleOffset:E,miniProgressBar:E,useSSR:E,playsInline:E,lock:E,gesture:E,fastForward:E,autoPlayback:E,autoOrientation:E,airplay:E,proxy:`?${W}`,plugins:[W],layers:[Z],contextmenu:[Z],settings:[Z],controls:[{...Z,position:(e,t,n)=>{const r=["top","left","right"];return V(r.includes(e),`${n.join(".")} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${E}`,html:P,url:P}],highlight:[{time:D,text:P}],thumbnails:{url:P,number:D,column:D,width:D,height:D,scale:D},subtitle:{url:P,name:P,type:P,style:U,escape:E,encoding:P,onVttLoad:W},moreVideoAttr:U,i18n:U,icons:U,cssVar:U,customType:U};class j{constructor(t){this.id=0,this.art=t,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return H(this.art.template.$player,`art-${this.name}-show`)}set show(t){const{$player:n}=this.art.template,r=`art-${this.name}-show`;t?w(n,r):I(n,r),this.art.emit(this.name,t)}toggle(){this.show=!this.show}add(t){const n=typeof t=="function"?t(this.art):t;if(n.html=n.html||"",Q(n,Z),!this.$parent||!this.name||n.disable)return;const r=n.name||`${this.name}${this.id}`;V(!this.cache.has(r),`Can't add an existing [${r}] to the [${this.name}]`),this.id+=1;const o=S("div");w(o,`art-${this.name}`),w(o,`art-${this.name}-${r}`);const i=Array.from(this.$parent.children);o.dataset.index=n.index||this.id;const a=i.find(c=>Number(c.dataset.index)>=Number(o.dataset.index));a?a.insertAdjacentElement("beforebegin",o):g(this.$parent,o),n.html&&g(o,n.html),n.style&&pt(o,n.style),n.tooltip&&B(o,n.tooltip);const s=[];if(n.click){const c=this.art.events.proxy(o,"click",l=>{l.preventDefault(),n.click.call(this.art,this,l)});s.push(c)}return n.selector&&["left","right"].includes(n.position)&&this.selector(n,o,s),this[r]=o,this.cache.set(r,{$ref:o,events:s,option:n}),n.mounted&&n.mounted.call(this.art,o),o}remove(t){V(this.cache.has(t),`Can't find [${t}] from the [${this.name}]`);const n=this.cache.get(t);n.option.beforeUnmount&&n.option.beforeUnmount.call(this.art,n.$ref);for(const r of n.events)this.art.events.remove(r);this.cache.delete(t),delete this[t],dt(n.$ref)}update(t){if(this.cache.has(t.name)){const n=this.cache.get(t.name);t=Object.assign(n.option,t),this.remove(t.name)}return this.add(t)}}function le(e){return t=>{const{i18n:n,constructor:{ASPECT_RATIO:r}}=t,o=r.map(i=>`<span data-value="${i}">${i==="default"?n.get("Default"):i}</span>`).join("");return{...e,html:`${n.get("Aspect Ratio")}: ${o}`,click:(i,a)=>{const{value:s}=a.target.dataset;s&&(t.aspectRatio=s,i.show=!1)},mounted:i=>{const a=A('[data-value="default"]',i);a&&N(a,"art-current"),t.on("aspectRatio",s=>{const c=ot("span",i).find(l=>l.dataset.value===s);c&&N(c,"art-current")})}}}}function ce(e){return t=>({...e,html:t.i18n.get("Close"),click:n=>{n.show=!1}})}function de(e){return t=>{const{i18n:n,constructor:{FLIP:r}}=t,o=r.map(i=>`<span data-value="${i}">${n.get(ht(i))}</span>`).join("");return{...e,html:`${n.get("Video Flip")}: ${o}`,click:(i,a)=>{const{value:s}=a.target.dataset;s&&(t.flip=s.toLowerCase(),i.show=!1)},mounted:i=>{const a=A('[data-value="normal"]',i);a&&N(a,"art-current"),t.on("flip",s=>{const c=ot("span",i).find(l=>l.dataset.value===s);c&&N(c,"art-current")})}}}}function pe(e){return t=>({...e,html:t.i18n.get("Video Info"),click:n=>{t.info.show=!0,n.show=!1}})}function he(e){return t=>{const{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,o=r.map(i=>`<span data-value="${i}">${i===1?n.get("Normal"):i.toFixed(1)}</span>`).join("");return{...e,html:`${n.get("Play Speed")}: ${o}`,click:(i,a)=>{const{value:s}=a.target.dataset;s&&(t.playbackRate=Number(s),i.show=!1)},mounted:i=>{const a=A('[data-value="1"]',i);a&&N(a,"art-current"),t.on("video:ratechange",()=>{const s=ot("span",i).find(c=>Number(c.dataset.value)===t.playbackRate);s&&N(s,"art-current")})}}}}function ue(e){const t=ct?location.href:"";return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${mt}</a>`}}class fe extends j{constructor(t){super(t),this.name="contextmenu",this.$parent=t.template.$contextmenu,M||this.init()}init(){const{option:t,proxy:n,template:{$player:r,$contextmenu:o}}=this.art;t.playbackRate&&this.add(he({name:"playbackRate",index:10})),t.aspectRatio&&this.add(le({name:"aspectRatio",index:20})),t.flip&&this.add(de({name:"flip",index:30})),this.add(pe({name:"info",index:40})),this.add(ue({name:"version",index:50})),this.add(ce({name:"close",index:60}));for(let i=0;i<t.contextmenu.length;i++)this.add(t.contextmenu[i]);n(r,"contextmenu",i=>{if(!this.art.constructor.CONTEXTMENU)return;i.preventDefault(),this.show=!0;const a=i.clientX,s=i.clientY,{height:c,width:l,left:d,top:h}=Y(r),{height:u,width:m}=Y(o);let f=a-d,y=s-h;a+m>d+l&&(f=l-m),s+u>h+c&&(y=c-u),pt(o,{top:`${y}px`,left:`${f}px`})}),n(r,"click",i=>{q(i,o)||(this.show=!1)}),this.art.on("blur",()=>{this.show=!1})}}function me(e){return t=>({...e,tooltip:t.i18n.get("AirPlay"),mounted:n=>{const{proxy:r,icons:o}=t;g(n,o.airplay),r(n,"click",()=>t.airplay())}})}function ge(e){return t=>({...e,tooltip:t.i18n.get("Fullscreen"),mounted:n=>{const{proxy:r,icons:o,i18n:i}=t,a=g(n,o.fullscreenOn),s=g(n,o.fullscreenOff);p(s,"display","none"),r(n,"click",()=>{t.fullscreen=!t.fullscreen}),t.on("fullscreen",c=>{c?(B(n,i.get("Exit Fullscreen")),p(a,"display","none"),p(s,"display","inline-flex")):(B(n,i.get("Fullscreen")),p(a,"display","inline-flex"),p(s,"display","none"))})}})}function ve(e){return t=>({...e,tooltip:t.i18n.get("Web Fullscreen"),mounted:n=>{const{proxy:r,icons:o,i18n:i}=t,a=g(n,o.fullscreenWebOn),s=g(n,o.fullscreenWebOff);p(s,"display","none"),r(n,"click",()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on("fullscreenWeb",c=>{c?(B(n,i.get("Exit Web Fullscreen")),p(a,"display","none"),p(s,"display","inline-flex")):(B(n,i.get("Web Fullscreen")),p(a,"display","inline-flex"),p(s,"display","none"))})}})}function ye(e){return t=>({...e,tooltip:t.i18n.get("PIP Mode"),mounted:n=>{const{proxy:r,icons:o,i18n:i}=t;g(n,o.pip),r(n,"click",()=>{t.pip=!t.pip}),t.on("pip",a=>{B(n,i.get(a?"Exit PIP Mode":"PIP Mode"))})}})}function be(e){return t=>({...e,mounted:n=>{const{proxy:r,icons:o,i18n:i}=t,a=g(n,o.play),s=g(n,o.pause);B(a,i.get("Play")),B(s,i.get("Pause")),r(a,"click",()=>{t.play()}),r(s,"click",()=>{t.pause()});function c(){p(a,"display","flex"),p(s,"display","none")}function l(){p(a,"display","none"),p(s,"display","flex")}t.playing?l():c(),t.on("video:playing",()=>{l()}),t.on("video:pause",()=>{c()})}})}function J(e,t){const{$progress:n}=e.template,{left:r}=Y(n),o=M?t.touches[0].clientX:t.clientX,i=_(o-r,0,n.clientWidth),a=i/n.clientWidth*e.duration,s=F(a),c=_(i/n.clientWidth,0,1);return{second:a,time:s,width:i,percentage:c}}function Ft(e,t){if(e.isRotate){const n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit("setBar","played",n,t),e.seek=r}else{const{second:n,percentage:r}=J(e,t);e.emit("setBar","played",r,t),e.seek=n}}function we(e){return t=>{const{icons:n,option:r,proxy:o}=t,{$player:i,$progress:a}=t.template;return{...e,html:`
            ...
            `,mounted:s=>{let c=null,l=!1;const d=A(".art-progress-hover",s),h=A(".art-progress-loaded",s),u=A(".art-progress-played",s),m=A(".art-progress-highlight",s),f=A(".art-progress-indicator",s),y=A(".art-progress-tip",s);n.indicator?g(f,n.indicator):p(f,"backgroundColor","var(--art-theme)");function b(k){const{width:T}=J(t,k),{text:R}=k.target.dataset;y.textContent=R;const O=y.clientWidth;T<=O/2?p(y,"left",0):T>s.clientWidth-O/2?p(y,"left",`${s.clientWidth-O}px`):p(y,"left",`${T-O/2}px`)}function $(k,T){const{width:R,time:O}=T||J(t,k);y.textContent=O||"00:00";const G=y.clientWidth;R<=G/2?p(y,"left",0):R>s.clientWidth-G/2?p(y,"left",`${s.clientWidth-G}px`):p(y,"left",`${R-G/2}px`)}function C(){m.textContent="";for(let k=0;k<r.highlight.length;k++){const T=r.highlight[k],R=_(T.time,0,t.duration)/t.duration*100,O=`<span data-text="${T.text}" data-time="${T.time}" style="left: ${R}%"></span>`;g(m,O)}}function L(k,T,R){const O=k==="played"&&R&&M;if(k==="loaded"&&p(h,"width",`${T*100}%`),k==="hover"&&(p(d,"width",`${T*100}%`),q(R,m)?b(R):$(R),T===0?I(i,"art-progress-hover"):w(i,"art-progress-hover")),k==="played"&&(p(u,"width",`${T*100}%`),p(f,"left",`${T*100}%`)),O){w(i,"art-progress-hover");const G=s.clientWidth*T,Wt=F(T*t.duration);$(R,{width:G,time:Wt}),clearTimeout(c),c=setTimeout(()=>{I(i,"art-progress-hover")},500)}}t.on("setBar",L),t.on("video:loadedmetadata",C),t.constructor.USE_RAF?t.on("raf",()=>{t.emit("setBar","played",t.played),t.emit("setBar","loaded",t.loaded)}):(t.on("video:timeupdate",()=>{t.emit("setBar","played",t.played)}),t.on("video:progress",()=>{t.emit("setBar","loaded",t.loaded)}),t.on("video:ended",()=>{t.emit("setBar","played",1)})),t.emit("setBar","loaded",t.loaded||0),M||(o(a,"click",k=>{k.target!==f&&Ft(t,k)}),o(a,"mousemove",k=>{const{percentage:T}=J(t,k);t.emit("setBar","hover",T,k)}),o(a,"mouseleave",k=>{t.emit("setBar","hover",0,k)}),o(a,"mousedown",k=>{l=k.button===0}),t.on("document:mousemove",k=>{if(l){const{second:T,percentage:R}=J(t,k);t.emit("setBar","played",R,k),t.seek=T}}),t.on("document:mouseup",()=>{l&&(l=!1)}))}}}}function xe(e){return t=>({...e,tooltip:t.i18n.get("Screenshot"),mounted:n=>{const{proxy:r,icons:o}=t;g(n,o.screenshot),r(n,"click",()=>{t.screenshot()})}})}function ke(e){return t=>({...e,tooltip:t.i18n.get("Show Setting"),mounted:n=>{const{proxy:r,icons:o,i18n:i}=t;g(n,o.setting),r(n,"click",()=>{t.setting.toggle(),t.setting.resize()}),t.on("setting",a=>{B(n,i.get(a?"Hide Setting":"Show Setting"))})}})}function $e(e){return t=>({...e,style:M?{fontSize:"12px",padding:"0 5px"}:{cursor:"auto",padding:"0 10px"},mounted:n=>{function r(){const i=`${F(t.currentTime)} / ${F(t.duration)}`;i!==n.textContent&&(n.textContent=i)}r();const o=["video:loadedmetadata","video:timeupdate","video:progress"];for(let i=0;i<o.length;i++)t.on(o[i],r)}})}function Te(e){return t=>({...e,mounted:n=>{const{proxy:r,icons:o}=t,i=g(n,o.volume),a=g(n,o.volumeClose),s=g(n,'<div class="art-volume-panel"></div>'),c=g(s,'<div class="art-volume-inner"></div>'),l=g(c,'<div class="art-volume-val"></div>'),d=g(c,'<div class="art-volume-slider"></div>'),h=g(d,'<div class="art-volume-handle"></div>'),u=g(h,'<div class="art-volume-loaded"></div>'),m=g(d,'<div class="art-volume-indicator"></div>');function f(b){const{top:$,height:C}=Y(d);return 1-(b.clientY-$)/C}function y(){if(t.muted||t.volume===0)p(i,"display","none"),p(a,"display","flex"),p(m,"top","100%"),p(u,"top","100%"),l.textContent=0;else{const b=t.volume*100;p(i,"display","flex"),p(a,"display","none"),p(m,"top",`${100-b}%`),p(u,"top",`${100-b}%`),l.textContent=Math.floor(b)}}if(y(),t.on("video:volumechange",y),r(i,"click",()=>{t.muted=!0}),r(a,"click",()=>{t.muted=!1}),M)p(s,"display","none");else{let b=!1;r(d,"mousedown",$=>{b=$.button===0,t.volume=f($)}),t.on("document:mousemove",$=>{b&&(t.muted=!1,t.volume=f($))}),t.on("document:mouseup",()=>{b&&(b=!1)})}}})}class Ee extends j{constructor(t){super(t),this.isHover=!1,this.name="control",this.timer=Date.now();const{constructor:n}=t,{$player:r,$bottom:o}=this.art.template;t.on("mousemove",()=>{M||(this.show=!0)}),t.on("click",()=>{M?this.toggle():this.show=!0}),t.on("document:mousemove",i=>{this.isHover=q(i,o)}),t.on("video:timeupdate",()=>{!t.setting.show&&!this.isHover&&!t.isInput&&t.playing&&this.show&&Date.now()-this.timer>=n.CONTROL_HIDE_TIME&&(this.show=!1)}),t.on("control",i=>{i?(I(r,"art-hide-cursor"),w(r,"art-hover"),this.timer=Date.now()):(w(r,"art-hide-cursor"),I(r,"art-hover"))}),this.init()}init(){const{option:t}=this.art;t.isLive||this.add(we({name:"progress",position:"top",index:10})),this.add({name:"thumbnails",position:"top",index:20}),this.add(be({name:"playAndPause",position:"left",index:10})),this.add(Te({name:"volume",position:"left",index:20})),t.isLive||this.add($e({name:"time",position:"left",index:30})),t.quality.length&&K().then(()=>{this.art.quality=t.quality}),t.screenshot&&!M&&this.add(xe({name:"screenshot",position:"right",index:20})),t.setting&&this.add(ke({name:"setting",position:"right",index:30})),t.pip&&this.add(ye({name:"pip",position:"right",index:40})),t.airplay&&window.WebKitPlaybackTargetAvailabilityEvent&&this.add(me({name:"airplay",position:"right",index:50})),t.fullscreenWeb&&this.add(ve({name:"fullscreenWeb",position:"right",index:60})),t.fullscreen&&this.add(ge({name:"fullscreen",position:"right",index:70}));for(let n=0;n<t.controls.length;n++)this.add(t.controls[n])}add(t){const n=typeof t=="function"?t(this.art):t,{$progress:r,$controlsLeft:o,$controlsRight:i}=this.art.template;switch(n.position){case"top":this.$parent=r;break;case"left":this.$parent=o;break;case"right":this.$parent=i;break;default:V(!1,"Control option.position must one of 'top', 'left', 'right'");break}super.add(n)}check(t){if(t){t.$control_value.innerHTML=t.html;for(let n=0;n<t.$control_option.length;n++){const r=t.$control_option[n];r.default=r===t,r.default&&N(r.$control_item,"art-current")}}}selector(t,n,r){const{proxy:o}=this.art.events;w(n,"art-control-selector");const i=S("div");w(i,"art-selector-value"),g(i,t.html),n.textContent="",g(n,i);const a=S("div");w(a,"art-selector-list"),g(n,a);for(let c=0;c<t.selector.length;c++){const l=t.selector[c],d=S("div");w(d,"art-selector-item"),l.default&&w(d,"art-current"),d.dataset.index=c,d.dataset.value=l.value,d.innerHTML=l.html,g(a,d),v(l,"$control_option",{get:()=>t.selector}),v(l,"$control_item",{get:()=>d}),v(l,"$control_value",{get:()=>i})}const s=o(a,"click",async c=>{const l=yt(c),d=t.selector.find(h=>h.$control_item===l.find(u=>h.$control_item===u));this.check(d),t.onSelect&&(i.innerHTML=await t.onSelect.call(this.art,d,d.$control_item,c))});r.push(s)}}function Ce(e,t){const{constructor:n,template:{$player:r,$video:o}}=e;function i(s){q(s,r)?(e.isInput=s.target.tagName==="INPUT",e.isFocus=!0,e.emit("focus",s)):(e.isInput=!1,e.isFocus=!1,e.emit("blur",s))}e.on("document:click",i),e.on("document:contextmenu",i);let a=[];t.proxy(o,"click",s=>{const c=Date.now();a.push(c);const{MOBILE_CLICK_PLAY:l,DBCLICK_TIME:d,MOBILE_DBCLICK_PLAY:h,DBCLICK_FULLSCREEN:u}=n,m=a.filter(f=>c-f<=d);switch(m.length){case 1:e.emit("click",s),M?!e.isLock&&l&&e.toggle():e.toggle(),a=m;break;case 2:e.emit("dblclick",s),M?!e.isLock&&h&&e.toggle():u&&(e.fullscreen=!e.fullscreen),a=[];break;default:a=[]}})}function Le(e,t){return Math.atan2(t,e)*180/Math.PI}function Me(e,t,n,r){const o=t-r,i=n-e;let a=0;if(Math.abs(i)<2&&Math.abs(o)<2)return a;const s=Le(i,o);return s>=-45&&s<45?a=4:s>=45&&s<135?a=1:s>=-135&&s<-45?a=2:(s>=135&&s<=180||s>=-180&&s<-135)&&(a=3),a}function Se(e,t){if(M&&!e.option.isLive){const{$video:n,$progress:r}=e.template;let o=null,i=!1,a=0,s=0,c=0;const l=u=>{if(u.touches.length===1&&!e.isLock){o===r&&Ft(e,u),i=!0;const{pageX:m,pageY:f}=u.touches[0];a=m,s=f,c=e.currentTime}},d=u=>{if(u.touches.length===1&&i&&e.duration){const{pageX:m,pageY:f}=u.touches[0],y=Me(a,s,m,f),b=[3,4].includes(y),$=[1,2].includes(y);if(b&&!e.isRotate||$&&e.isRotate){const L=_((m-a)/e.width,-1,1),k=_((f-s)/e.height,-1,1),T=e.isRotate?k:L,R=o===n?e.constructor.TOUCH_MOVE_RATIO:1,O=_(c+e.duration*T*R,0,e.duration);e.seek=O,e.emit("setBar","played",_(O/e.duration,0,1),u),e.notice.show=`${F(O)} / ${F(e.duration)}`}}},h=()=>{i&&(a=0,s=0,c=0,i=!1,o=null)};e.option.gesture&&(t.proxy(n,"touchstart",u=>{o=n,l(u)}),t.proxy(n,"touchmove",d)),t.proxy(r,"touchstart",u=>{o=r,l(u)}),t.proxy(r,"touchmove",d),e.on("document:touchend",h)}}function ze(e,t){const n=["click","mouseup","keydown","touchend","touchmove","mousemove","pointerup","contextmenu","pointermove","visibilitychange","webkitfullscreenchange"],r=["resize","scroll","orientationchange"],o=[];function i(a={}){for(let c=0;c<o.length;c++)t.remove(o[c]);o.length=0;const{$player:s}=e.template;n.forEach(c=>{const l=a.document||s.ownerDocument||document,d=t.proxy(l,c,h=>{e.emit(`document:${c}`,h)});o.push(d)}),r.forEach(c=>{const l=a.window||s.ownerDocument?.defaultView||window,d=t.proxy(l,c,h=>{e.emit(`window:${c}`,h)});o.push(d)})}i(),t.bindGlobalEvents=i}function Ie(e,t){const{$player:n}=e.template;t.hover(n,r=>{w(n,"art-hover"),e.emit("hover",!0,r)},r=>{I(n,"art-hover"),e.emit("hover",!1,r)})}function Pe(e,t){const{$player:n}=e.template;t.proxy(n,"mousemove",r=>{e.emit("mousemove",r)})}function Re(e,t){const{option:n,constructor:r}=e;e.on("resize",()=>{const{aspectRatio:i,notice:a}=e;e.state==="standard"&&n.autoSize&&e.autoSize(),e.aspectRatio=i,a.show=""});const o=Dt(()=>e.emit("resize"),r.RESIZE_TIME);e.on("window:orientationchange",()=>o()),e.on("window:resize",()=>o()),screen&&screen.orientation&&screen.orientation.onchange&&t.proxy(screen.orientation,"change",()=>o())}function Ae(e){if(e.constructor.USE_RAF){let t=null;(function n(){e.playing&&e.emit("raf"),e.isDestroy||(t=requestAnimationFrame(n))})(),e.on("destroy",()=>{cancelAnimationFrame(t)})}}function _e(e){const{option:t,constructor:n,template:{$container:r}}=e,o=Nt(()=>{e.emit("view",gt(r,n.SCROLL_GAP))},n.SCROLL_TIME);e.on("window:scroll",()=>o()),e.on("view",i=>{t.autoMini&&(e.mini=!i)})}class Oe{constructor(t){this.destroyEvents=new Set,this.proxy=this.proxy.bind(this),this.hover=this.hover.bind(this),Ce(t,this),Ie(t,this),Pe(t,this),Re(t,this),Se(t,this),_e(t),ze(t,this),Ae(t)}proxy(t,n,r,o={}){if(Array.isArray(n))return n.map(a=>this.proxy(t,a,r,o));t.addEventListener(n,r,o);const i=()=>t.removeEventListener(n,r,o);return this.destroyEvents.add(i),i}hover(t,n,r){n&&this.proxy(t,"mouseenter",n),r&&this.proxy(t,"mouseleave",r)}remove(t){if(this.destroyEvents.has(t))try{t()}catch(n){console.warn("Failed to remove event listener:",n)}finally{this.destroyEvents.delete(t)}}destroy(){for(const t of this.destroyEvents)try{t()}catch(n){console.warn("Failed to destroy event listener:",n)}this.destroyEvents.clear()}}class Ve{constructor(t){this.art=t,this.keys={},M||this.init()}init(){const{constructor:t}=this.art;this.art.option.hotkey&&(this.add("Escape",()=>{this.art.fullscreenWeb&&(this.art.fullscreenWeb=!1)}),this.add("Space",()=>{this.art.toggle()}),this.add("ArrowLeft",()=>{this.art.backward=t.SEEK_STEP}),this.add("ArrowUp",()=>{this.art.volume+=t.VOLUME_STEP}),this.add("ArrowRight",()=>{this.art.forward=t.SEEK_STEP}),this.add("ArrowDown",()=>{this.art.volume-=t.VOLUME_STEP})),this.art.on("document:keydown",n=>{if(this.art.isFocus){const r=document.activeElement.tagName.toUpperCase(),o=document.activeElement.getAttribute("contenteditable");if(r!=="INPUT"&&r!=="TEXTAREA"&&o!==""&&o!=="true"&&!n.altKey&&!n.ctrlKey&&!n.metaKey&&!n.shiftKey){const i=this.keys[n.code];if(i){n.preventDefault();for(let a=0;a<i.length;a++)i[a].call(this.art,n);this.art.emit("hotkey",n)}}}this.art.emit("keydown",n)})}add(t,n){return this.keys[t]?this.keys[t].includes(n)||this.keys[t].push(n):this.keys[t]=[n],this}remove(t,n){if(this.keys[t]){const r=this.keys[t].indexOf(n);r!==-1&&this.keys[t].splice(r,1),this.keys[t].length===0&&delete this.keys[t]}return this}}const Ht={"Video Info":"统计信息",Close:"关闭","Video Load Failed":"加载失败",Volume:"音量",Play:"播放",Pause:"暂停",Rate:"速度",Mute:"静音","Video Flip":"画面翻转",Horizontal:"水平",Vertical:"垂直",Reconnect:"重新连接","Show Setting":"显示设置","Hide Setting":"隐藏设置",Screenshot:"截图","Play Speed":"播放速度","Aspect Ratio":"画面比例",Default:"默认",Normal:"正常",Open:"打开","Switch Video":"切换","Switch Subtitle":"切换字幕",Fullscreen:"全屏","Exit Fullscreen":"退出全屏","Web Fullscreen":"网页全屏","Exit Web Fullscreen":"退出网页全屏","Mini Player":"迷你播放器","PIP Mode":"开启画中画","Exit PIP Mode":"退出画中画","PIP Not Supported":"不支持画中画","Fullscreen Not Supported":"不支持全屏","Subtitle Offset":"字幕偏移","Last Seen":"上次看到","Jump Play":"跳转播放",AirPlay:"隔空播放","AirPlay Not Available":"隔空播放不可用"};typeof window<"u"&&(window["artplayer-i18n-zh-cn"]=Ht);class De{constructor(t){this.art=t,this.languages={"zh-cn":Ht},this.language={},this.update(t.option.i18n)}init(){const t=this.art.option.lang.toLowerCase();this.language=this.languages[t]||{}}get(t){return this.language[t]||t}update(t){this.languages=ut(this.languages,t),this.init()}}const Ne=`<svg width="18px" height="18px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <g>
...
</svg>`,Xe='<svg height="24" viewBox="0 0 24 24" width="24"><path d="M15,17h6v1h-6V17z M11,17H3v1h8v2h1v-2v-1v-2h-1V17z M14,8h1V6V5V3h-1v2H3v1h11V8z            M18,5v1h3V5H18z M6,14h1v-2v-1V9H6v2H3v1 h3V14z M10,12h11v-1H10V12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>',je=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
</svg>`,Ue=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Ge=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg class="icon" width="22" height="22" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
`,Ke=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,Ze=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg class="icon" width="18" height="18" viewBox="0 0 1152 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
`,Je=`<svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-default">
...
</svg>`,Qe=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,tn=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M7 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2zM15 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2z"></path>
</svg>`,en=`<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="22" height="22">
...
</svg>`,nn=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
  <path d="M17.982 9.275L8.06 3.27A2.013 2.013 0 0 0 5 4.994v12.011a2.017 2.017 0 0 0 3.06 1.725l9.922-6.005a2.017 2.017 0 0 0 0-3.45z"></path>
</svg>`,rn='<svg height="24" viewBox="0 0 24 24" width="24"><path d="M10,8v8l6-4L10,8L10,8z M6.3,5L5.7,4.2C7.2,3,9,2.2,11,2l0.1,1C9.3,3.2,7.7,3.9,6.3,5z            M5,6.3L4.2,5.7C3,7.2,2.2,9,2,11 l1,.1C3.2,9.3,3.9,7.7,5,6.3z            M5,17.7c-1.1-1.4-1.8-3.1-2-4.8L2,13c0.2,2,1,3.8,2.2,5.4L5,17.7z            M11.1,21c-1.8-0.2-3.4-0.9-4.8-2 l-0.6,.8C7.2,21,9,21.8,11,22L11.1,21z            M22,12c0-5.2-3.9-9.4-9-10l-0.1,1c4.6,.5,8.1,4.3,8.1,9s-3.5,8.5-8.1,9l0.1,1 C18.2,21.5,22,17.2,22,12z" data-darkreader-inline-fill="" style="--darkreader-inline-fill:#a8a6a4;"></path></svg>',on=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 50 50">
...
`,an=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
...
</svg>`,sn=`<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24">
...
`,ln=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,cn=`<?xml version="1.0" standalone="no"?>
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
...
`,pn=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M15 11a3.998 3.998 0 0 0-2-3.465v2.636l1.865 1.865A4.02 4.02 0 0 0 15 11z"></path>
    <path d="M13.583 5.583A5.998 5.998 0 0 1 17 11a6 6 0 0 1-.585 2.587l1.477 1.477a8.001 8.001 0 0 0-3.446-11.286 1 1 0 0 0-.863 1.805zM18.778 18.778l-2.121-2.121-1.414-1.414-1.415-1.415L13 13l-2-2-3.889-3.889-3.889-3.889a.999.999 0 1 0-1.414 1.414L5.172 8H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1l4.188 3.35a.5.5 0 0 0 .812-.39v-3.131l2.587 2.587-.01.005a1 1 0 0 0 .86 1.806c.215-.102.424-.214.627-.333l2.3 2.3a1.001 1.001 0 0 0 1.414-1.416zM11 5.04a.5.5 0 0 0-.813-.39L8.682 5.854 11 8.172V5.04z"></path>
</svg>`,hn=`<svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 22 22">
    <path d="M10.188 4.65L6 8H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1l4.188 3.35a.5.5 0 0 0 .812-.39V5.04a.498.498 0 0 0-.812-.39zM14.446 3.778a1 1 0 0 0-.862 1.804 6.002 6.002 0 0 1-.007 10.838 1 1 0 0 0 .86 1.806A8.001 8.001 0 0 0 19 11a8.001 8.001 0 0 0-4.554-7.222z"></path>
    <path d="M15 11a3.998 3.998 0 0 0-2-3.465v6.93A3.998 3.998 0 0 0 15 11z"></path>
</svg>`;class un{constructor(t){const n={loading:Je,state:sn,play:nn,pause:tn,check:Be,volume:hn,volumeClose:pn,screenshot:on,setting:an,pip:en,arrowLeft:Ye,arrowRight:Fe,playbackRate:rn,aspectRatio:He,config:Xe,lock:Qe,flip:Ue,unlock:dn,fullscreenOff:qe,fullscreenOn:Ge,fullscreenWebOff:Ke,fullscreenWebOn:Ze,switchOn:cn,switchOff:ln,error:je,close:We,airplay:Ne,...t.option.icons};for(const r in n)v(this,r,{get:()=>Mt(r,n[r])})}}class fn extends j{constructor(t){super(t),this.name="info",M||this.init()}init(){const{proxy:t,constructor:n,template:{$infoPanel:r,$infoClose:o,$video:i}}=this.art;t(o,"click",()=>{this.show=!1});let a=null;const s=ot("[data-video]",r)||[];this.art.on("destroy",()=>clearTimeout(a));function c(){for(let l=0;l<s.length;l++){const d=s[l],h=i[d.dataset.video],u=typeof h=="number"?h.toFixed(2):h;d.textContent!==u&&(d.textContent=u)}a=setTimeout(c,n.INFO_LOOP_TIME)}c()}}class mn extends j{constructor(t){super(t);const{option:n,template:{$layer:r}}=t;this.name="layer",this.$parent=r;for(let o=0;o<n.layers.length;o++)this.add(n.layers[o])}}class gn extends j{constructor(t){super(t),this.name="loading",g(t.template.$loading,t.icons.loading)}}class vn extends j{constructor(t){super(t),this.name="mask";const{template:n,icons:r,events:o}=t,i=g(n.$state,r.state),a=g(n.$state,r.error);p(a,"display","none"),t.on("destroy",()=>{p(i,"display","none"),p(a,"display",null)}),o.proxy(n.$state,"click",()=>t.play())}}class yn{constructor(t){this.art=t,this.timer=null,t.on("destroy",()=>this.destroy())}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null)}set show(t){const{constructor:n,template:{$player:r,$noticeInner:o}}=this.art;t?(o.textContent=t instanceof Error?t.message.trim():t,w(r,"art-notice-show"),clearTimeout(this.timer),this.timer=setTimeout(()=>{o.textContent="",I(r,"art-notice-show")},n.NOTICE_TIME)):I(r,"art-notice-show")}get show(){const{template:{$player:t}}=this.art;return t.classList.contains("art-notice-show")}}function bn(e){const{i18n:t,notice:n,proxy:r,template:{$video:o}}=e;let i=!0;window.WebKitPlaybackTargetAvailabilityEvent&&o.webkitShowPlaybackTargetPicker?r(o,"webkitplaybacktargetavailabilitychanged",a=>{switch(a.availability){case"available":i=!0;break;case"not-available":i=!1;break}}):i=!1,v(e,"airplay",{value(){i?(o.webkitShowPlaybackTargetPicker(),e.emit("airplay")):n.show=t.get("AirPlay Not Available")}})}function wn(e){const{i18n:t,notice:n,template:{$video:r,$player:o}}=e;v(e,"aspectRatio",{get(){return o.dataset.aspectRatio||"default"},set(i){if(i||(i="default"),i==="default")p(r,"width",null),p(r,"height",null),p(r,"margin",null),delete o.dataset.aspectRatio;else{const a=i.split(":").map(Number),{clientWidth:s,clientHeight:c}=o,l=s/c,d=a[0]/a[1];l>d?(p(r,"width",`${d*c}px`),p(r,"height","100%"),p(r,"margin","0 auto")):(p(r,"width","100%"),p(r,"height",`${s/d}px`),p(r,"margin","auto 0")),o.dataset.aspectRatio=i}n.show=`${t.get("Aspect Ratio")}: ${i==="default"?t.get("Default"):i}`,e.emit("aspectRatio",i)}})}function xn(e){const{template:{$video:t}}=e;v(e,"attr",{value(n,r){if(r===void 0)return t[n];t[n]=r}})}function kn(e){const{template:{$container:t,$video:n}}=e;v(e,"autoHeight",{value(){const{clientWidth:r}=t,{videoHeight:o,videoWidth:i}=n,a=o*(r/i);p(t,"height",`${a}px`),e.emit("autoHeight",a)}})}function $n(e){const{$container:t,$player:n,$video:r}=e.template;v(e,"autoSize",{value(){const{videoWidth:o,videoHeight:i}=r,{width:a,height:s}=Y(t),c=o/i;if(a/s>c){const d=s*c/a*100;p(n,"width",`${d}%`),p(n,"height","100%")}else{const d=a/c/s*100;p(n,"width","100%"),p(n,"height",`${d}%`)}e.emit("autoSize",{width:e.width,height:e.height})}})}function Tn(e){const{$player:t}=e.template;v(e,"cssVar",{value(n,r){return r?t.style.setProperty(n,r):getComputedStyle(t).getPropertyValue(n)}})}function En(e){const{$video:t}=e.template;v(e,"currentTime",{get:()=>t.currentTime||0,set:n=>{n=Number.parseFloat(n),!Number.isNaN(n)&&(t.currentTime=_(n,0,e.duration))}})}function Cn(e){v(e,"duration",{get:()=>{const{duration:t}=e.template.$video;return t===1/0?0:t||0}})}function Ln(e){const{i18n:t,notice:n,option:r,constructor:o,proxy:i,template:{$player:a,$video:s,$poster:c}}=e;let l=0;for(let d=0;d<tt.events.length;d++)i(s,tt.events[d],h=>{e.emit(`video:${h.type}`,h)});e.on("video:canplay",()=>{l=0,e.loading.show=!1}),e.once("video:canplay",()=>{e.loading.show=!1,e.controls.show=!0,e.mask.show=!0,e.isReady=!0,e.emit("ready")}),e.on("video:ended",()=>{r.loop?(e.seek=0,e.play(),e.controls.show=!1,e.mask.show=!1):(e.controls.show=!0,e.mask.show=!0)}),e.on("video:error",async d=>{l<o.RECONNECT_TIME_MAX?(await K(o.RECONNECT_SLEEP_TIME),l+=1,e.url=r.url,n.show=`${t.get("Reconnect")}: ${l}`,e.emit("error",d,l)):(e.mask.show=!0,e.loading.show=!1,e.controls.show=!0,w(a,"art-error"),await K(o.RECONNECT_SLEEP_TIME),n.show=t.get("Video Load Failed"))}),e.on("video:loadedmetadata",()=>{e.emit("resize"),M&&(e.loading.show=!1,e.controls.show=!0,e.mask.show=!0)}),e.on("video:loadstart",()=>{e.loading.show=!0,e.mask.show=!1,e.controls.show=!0}),e.on("video:pause",()=>{e.controls.show=!0,e.mask.show=!0}),e.on("video:play",()=>{e.mask.show=!1,p(c,"display","none")}),e.on("video:playing",()=>{e.mask.show=!1}),e.on("video:progress",()=>{e.playing&&(e.loading.show=!1)}),e.on("video:seeked",()=>{e.loading.show=!1,e.mask.show=!0}),e.on("video:seeking",()=>{e.loading.show=!0,e.mask.show=!1}),e.on("video:timeupdate",()=>{e.mask.show=!1}),e.on("video:waiting",()=>{e.loading.show=!0,e.mask.show=!1})}function Mn(e){const{template:{$player:t},i18n:n,notice:r}=e;v(e,"flip",{get(){return t.dataset.flip||"normal"},set(o){o||(o="normal"),o==="normal"?delete t.dataset.flip:t.dataset.flip=o,r.show=`${n.get("Video Flip")}: ${n.get(ht(o))}`,e.emit("flip",o)}})}const xt=[["requestFullscreen","exitFullscreen","fullscreenElement","fullscreenEnabled","fullscreenchange","fullscreenerror"],["webkitRequestFullscreen","webkitExitFullscreen","webkitFullscreenElement","webkitFullscreenEnabled","webkitfullscreenchange","webkitfullscreenerror"],["webkitRequestFullScreen","webkitCancelFullScreen","webkitCurrentFullScreenElement","webkitCancelFullScreen","webkitfullscreenchange","webkitfullscreenerror"],["mozRequestFullScreen","mozCancelFullScreen","mozFullScreenElement","mozFullScreenEnabled","mozfullscreenchange","mozfullscreenerror"],["msRequestFullscreen","msExitFullscreen","msFullscreenElement","msFullscreenEnabled","MSFullscreenChange","MSFullscreenError"]],X=(()=>{if(typeof document>"u")return!1;const e=xt[0],t={};for(const n of xt)if(n[1]in document){for(const[o,i]of n.entries())t[e[o]]=i;return t}return!1})(),kt={change:X.fullscreenchange,error:X.fullscreenerror},z={request(e=document.documentElement,t){return new Promise((n,r)=>{const o=()=>{z.off("change",o),n()};z.on("change",o);const i=e[X.requestFullscreen](t);i instanceof Promise&&i.then(o).catch(r)})},exit(){return new Promise((e,t)=>{if(!z.isFullscreen){e();return}const n=()=>{z.off("change",n),e()};z.on("change",n);const r=document[X.exitFullscreen]();r instanceof Promise&&r.then(n).catch(t)})},toggle(e,t){return z.isFullscreen?z.exit():z.request(e,t)},onchange(e){z.on("change",e)},onerror(e){z.on("error",e)},on(e,t){const n=kt[e];n&&document.addEventListener(n,t,!1)},off(e,t){const n=kt[e];n&&document.removeEventListener(n,t,!1)},raw:X};Object.defineProperties(z,{isFullscreen:{get:()=>!!document[X.fullscreenElement]},element:{enumerable:!0,get:()=>document[X.fullscreenElement]},isEnabled:{enumerable:!0,get:()=>!!document[X.fullscreenEnabled]}});function Sn(e){const{i18n:t,notice:n,template:{$video:r,$player:o}}=e,i=s=>{z.on("change",()=>{s.emit("fullscreen",z.isFullscreen),z.isFullscreen?(s.state="fullscreen",w(o,"art-fullscreen")):I(o,"art-fullscreen"),s.emit("resize")}),z.on("error",c=>{s.emit("fullscreenError",c)}),v(s,"fullscreen",{get(){return z.isFullscreen},async set(c){c?await z.request(o):await z.exit()}})},a=s=>{s.on("document:webkitfullscreenchange",()=>{s.emit("fullscreen",s.fullscreen),s.emit("resize")}),v(s,"fullscreen",{get(){return document.fullscreenElement===r},set(c){c?(s.state="fullscreen",r.webkitEnterFullscreen()):r.webkitExitFullscreen()}})};e.once("video:loadedmetadata",()=>{z.isEnabled?i(e):r.webkitSupportsFullscreen?a(e):v(e,"fullscreen",{get(){return!1},set(){n.show=t.get("Fullscreen Not Supported")}}),v(e,"fullscreen",_t(e,"fullscreen"))})}function zn(e){const{constructor:t,template:{$container:n,$player:r}}=e;let o="";v(e,"fullscreenWeb",{get(){return H(r,"art-fullscreen-web")},set(i){i?(o=r.style.cssText,t.FULLSCREEN_WEB_IN_BODY&&g(document.body,r),e.state="fullscreenWeb",p(r,"width","100%"),p(r,"height","100%"),w(r,"art-fullscreen-web"),e.emit("fullscreenWeb",!0)):(t.FULLSCREEN_WEB_IN_BODY&&g(n,r),o&&(r.style.cssText=o,o=""),I(r,"art-fullscreen-web"),e.emit("fullscreenWeb",!1)),e.emit("resize")}})}function In(e){const{$video:t}=e.template;v(e,"loaded",{get:()=>e.loadedTime/t.duration}),v(e,"loadedTime",{get:()=>t.buffered.length?t.buffered.end(t.buffered.length-1):0})}function Pn(e){const{icons:t,proxy:n,storage:r,template:{$player:o,$video:i}}=e;let a=!1,s=0,c=0;function l(){const{$mini:m}=e.template;m&&(I(o,"art-mini"),p(m,"display","none"),o.prepend(i),e.emit("mini",!1))}function d(m,f){e.playing?(p(m,"display","none"),p(f,"display","flex")):(p(m,"display","flex"),p(f,"display","none"))}function h(){const{$mini:m}=e.template;if(m)return g(m,i),p(m,"display","flex");{const f=S("div");w(f,"art-mini-popup"),g(document.body,f),e.template.$mini=f,g(f,i);const y=g(f,'<div class="art-mini-close"></div>');g(y,t.close),n(y,"click",l);const b=g(f,'<div class="art-mini-state"></div>'),$=g(b,t.play),C=g(b,t.pause);return n($,"click",()=>e.play()),n(C,"click",()=>e.pause()),d($,C),e.on("video:playing",()=>d($,C)),e.on("video:pause",()=>d($,C)),e.on("video:timeupdate",()=>d($,C)),n(f,"mousedown",L=>{a=L.button===0,s=L.pageX,c=L.pageY}),e.on("document:mousemove",L=>{if(a){w(f,"art-mini-dragging");const k=L.pageX-s,T=L.pageY-c;p(f,"transform",`translate(${k}px, ${T}px)`)}}),e.on("document:mouseup",()=>{if(a){a=!1,I(f,"art-mini-dragging");const L=Y(f);r.set("left",L.left),r.set("top",L.top),p(f,"left",`${L.left}px`),p(f,"top",`${L.top}px`),p(f,"transform",null)}}),f}}function u(){const{$mini:m}=e.template,f=Y(m),y=window.innerHeight-f.height-50,b=window.innerWidth-f.width-50;r.set("top",y),r.set("left",b),p(m,"top",`${y}px`),p(m,"left",`${b}px`)}v(e,"mini",{get(){return H(o,"art-mini")},set(m){if(m){e.state="mini",w(o,"art-mini");const f=h(),y=r.get("top"),b=r.get("left");typeof y=="number"&&typeof b=="number"?(p(f,"top",`${y}px`),p(f,"left",`${b}px`),gt(f)||u()):u(),e.emit("mini",!0)}else l()}})}function Rn(e){const{option:t,storage:n,template:{$video:r,$poster:o}}=e;for(const a in t.moreVideoAttr)e.attr(a,t.moreVideoAttr[a]);t.muted&&(e.muted=t.muted),t.volume&&(r.volume=_(t.volume,0,1));const i=n.get("volume");typeof i=="number"&&(r.volume=_(i,0,1)),t.poster&&p(o,"backgroundImage",`url(${t.poster})`),t.autoplay&&(r.autoplay=t.autoplay),t.playsInline&&(r.playsInline=!0,r["webkit-playsinline"]=!0),t.theme&&(t.cssVar["--art-theme"]=t.theme);for(const a in t.cssVar)e.cssVar(a,t.cssVar[a]);e.url=t.url}function An(e){const{template:{$video:t},i18n:n,notice:r}=e;v(e,"pause",{value(){const o=t.pause();return r.show=n.get("Pause"),e.emit("pause"),o}})}function _n(e){const{template:{$video:t},proxy:n,notice:r}=e;t.disablePictureInPicture=!1,v(e,"pip",{get(){return document.pictureInPictureElement},set(o){o?(e.state="pip",t.requestPictureInPicture().catch(i=>{throw r.show=i,i})):document.exitPictureInPicture().catch(i=>{throw r.show=i,i})}}),n(t,"enterpictureinpicture",()=>{e.emit("pip",!0)}),n(t,"leavepictureinpicture",()=>{e.emit("pip",!1)})}function On(e){const{$video:t}=e.template;t.webkitSetPresentationMode("inline"),v(e,"pip",{get(){return t.webkitPresentationMode==="picture-in-picture"},set(n){n?(e.state="pip",t.webkitSetPresentationMode("picture-in-picture"),e.emit("pip",!0)):(t.webkitSetPresentationMode("inline"),e.emit("pip",!1))}})}function Vn(e){const{i18n:t,notice:n,template:{$video:r}}=e;document.pictureInPictureEnabled?_n(e):r.webkitSupportsPresentationMode?On(e):v(e,"pip",{get(){return!1},set(){n.show=t.get("PIP Not Supported")}})}function Dn(e){const{template:{$video:t},i18n:n,notice:r}=e;v(e,"playbackRate",{get(){return t.playbackRate},set(o){if(o){if(o===t.playbackRate)return;t.playbackRate=o,r.show=`${n.get("Rate")}: ${o===1?n.get("Normal"):`${o}x`}`}else e.playbackRate=1}})}function Nn(e){v(e,"played",{get:()=>e.currentTime/e.duration})}function Yn(e){const{$video:t}=e.template;v(e,"playing",{get:()=>typeof t.playing=="boolean"?t.playing:t.currentTime>0&&!t.paused&&!t.ended&&t.readyState>2})}function Fn(e){const{i18n:t,notice:n,option:r,constructor:{instances:o},template:{$video:i}}=e;v(e,"play",{async value(){const a=await i.play();if(n.show=t.get("Play"),e.emit("play"),r.mutex)for(let s=0;s<o.length;s++){const c=o[s];c!==e&&c.pause()}return a}})}function Hn(e){const{template:{$poster:t}}=e;v(e,"poster",{get:()=>{try{return t.style.backgroundImage.match(/"(.*)"/)[1]}catch{return""}},set(n){p(t,"backgroundImage",`url(${n})`)}})}function Bn(e){v(e,"quality",{set(t){const{controls:n,notice:r,i18n:o}=e,i=t.find(a=>a.default)||t[0];n.update({name:"quality",position:"right",index:10,style:{marginRight:"10px"},html:i?.html||"",selector:t,async onSelect(a){return await e.switchQuality(a.url),r.show=`${o.get("Switch Video")}: ${a.html}`,a.html}})}})}function Wn(e){v(e,"rect",{get:()=>Y(e.template.$player)});const t=["bottom","height","left","right","top","width"];for(let n=0;n<t.length;n++){const r=t[n];v(e,r,{get:()=>e.rect[r]})}v(e,"x",{get:()=>e.left+window.pageXOffset}),v(e,"y",{get:()=>e.top+window.pageYOffset})}function Xn(e){const{notice:t,template:{$video:n}}=e,r=S("canvas");v(e,"getDataURL",{value:()=>new Promise((o,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext("2d").drawImage(n,0,0),o(r.toDataURL("image/png"))}catch(a){t.show=a,i(a)}})}),v(e,"getBlobUrl",{value:()=>new Promise((o,i)=>{try{r.width=n.videoWidth,r.height=n.videoHeight,r.getContext("2d").drawImage(n,0,0),r.toBlob(a=>{o(URL.createObjectURL(a))})}catch(a){t.show=a,i(a)}})}),v(e,"screenshot",{value:async o=>{const i=await e.getDataURL(),a=o||`artplayer_${F(n.currentTime)}`;return Rt(i,`${a}.png`),e.emit("screenshot",i),i}})}function jn(e){const{notice:t}=e;v(e,"seek",{set(n){e.currentTime=n,e.duration&&(t.show=`${F(e.currentTime)} / ${F(e.duration)}`),e.emit("seek",e.currentTime,n)}}),v(e,"forward",{set(n){e.seek=e.currentTime+n}}),v(e,"backward",{set(n){e.seek=e.currentTime-n}})}function Un(e){const t=["mini","pip","fullscreen","fullscreenWeb"];v(e,"state",{get:()=>t.find(n=>e[n])||"standard",set(n){for(let r=0;r<t.length;r++){const o=t[r];o!==n&&e[o]&&(e[o]=!1)}}})}function qn(e){const{notice:t,i18n:n,template:r}=e;v(e,"subtitleOffset",{get(){return r.$track?.offset||0},set(o){const{cues:i}=e.subtitle;if(!r.$track||i.length===0)return;const a=_(o,-10,10);r.$track.offset=a;for(let s=0;s<i.length;s++){const c=i[s];c.originalStartTime=c.originalStartTime??c.startTime,c.originalEndTime=c.originalEndTime??c.endTime,c.startTime=_(c.originalStartTime+a,0,e.duration),c.endTime=_(c.originalEndTime+a,0,e.duration)}e.subtitle.update(),t.show=`${n.get("Subtitle Offset")}: ${o}s`,e.emit("subtitleOffset",o)}})}function Gn(e){function t(n,r){return new Promise((o,i)=>{if(n===e.url){o();return}const{playing:a,aspectRatio:s,playbackRate:c}=e;e.pause(),e.url=n,e.notice.show="";const l={};l.error=d=>{e.off("video:canplay",l.canplay),e.off("video:loadedmetadata",l.metadata),i(d)},l.metadata=()=>{e.currentTime=r},l.canplay=async()=>{e.off("video:error",l.error),e.playbackRate=c,e.aspectRatio=s,a&&await e.play(),e.notice.show="",o()},e.once("video:error",l.error),e.once("video:loadedmetadata",l.metadata),e.once("video:canplay",l.canplay)})}v(e,"switchQuality",{value:n=>t(n,e.currentTime)}),v(e,"switchUrl",{value:n=>t(n,0)}),v(e,"switch",{set:e.switchUrl})}function Kn(e){v(e,"theme",{get(){return e.cssVar("--art-theme")},set(t){e.cssVar("--art-theme",t)}})}function Zn(e){const{option:t,template:{$progress:n,$video:r}}=e;let o=null,i=!1,a=null;function s(){clearTimeout(o),o=null,i=!1,a=null}function c(l){const d=e.controls?.thumbnails;if(!d)return;const{number:h,column:u,width:m,height:f,scale:y}=t.thumbnails,b=m*y||a.naturalWidth/u,$=f*y||b/(r.videoWidth/r.videoHeight),C=n.clientWidth/h,L=Math.floor(l/C),k=Math.ceil(L/u)-1,T=L%u||u-1;p(d,"backgroundImage",`url(${a.src})`),p(d,"height",`${$}px`),p(d,"width",`${b}px`),p(d,"backgroundPosition",`-${T*b}px -${k*$}px`),l<=b/2?p(d,"left",0):l>n.clientWidth-b/2?p(d,"left",`${n.clientWidth-b}px`):p(d,"left",`${l-b/2}px`)}e.on("setBar",async(l,d,h)=>{const u=e.controls?.thumbnails,{url:m,scale:f}=t.thumbnails;if(!u||!m)return;if(l==="hover"||l==="played"&&h&&M){if(!a&&!i&&(i=!0,a=await It(m,f),i=!1),!a)return;const b=n.clientWidth*d;b>0&&b<n.clientWidth&&c(b)}}),v(e,"thumbnails",{get(){return e.option.thumbnails},set(l){l.url&&!e.option.isLive&&(e.option.thumbnails=l,s())}})}function Jn(e){v(e,"toggle",{value(){return e.playing?e.pause():e.play()}})}function Qn(e){v(e,"type",{get(){return e.option.type},set(t){e.option.type=t}})}function tr(e){const{option:t,template:{$video:n}}=e;v(e,"url",{get(){return n.src},async set(r){if(r){const o=e.url,i=t.type||nt(r),a=t.customType[i];i&&a?(await K(),e.loading.show=!0,a.call(e,n,r,e)):(URL.revokeObjectURL(o),n.src=r),o!==e.url&&(e.option.url=r,e.isReady&&o&&e.once("video:canplay",()=>{e.emit("restart",r)}))}else await K(),e.loading.show=!0}})}function er(e){const{template:{$video:t},i18n:n,notice:r,storage:o}=e;v(e,"volume",{get:()=>t.volume||0,set:i=>{t.volume=_(i,0,1),r.show=`${n.get("Volume")}: ${Number.parseInt(t.volume*100,10)}`,t.volume!==0&&o.set("volume",t.volume)}}),v(e,"muted",{get:()=>t.muted,set:i=>{t.muted=i,e.emit("muted",i)}})}class nr{constructor(t){tr(t),xn(t),Fn(t),An(t),Jn(t),jn(t),er(t),En(t),Cn(t),Gn(t),Dn(t),wn(t),Xn(t),Sn(t),zn(t),Vn(t),In(t),Nn(t),Yn(t),$n(t),Wn(t),Mn(t),Pn(t),Hn(t),kn(t),Tn(t),Kn(t),Qn(t),Un(t),qn(t),bn(t),Bn(t),Zn(t),Ln(t),Rn(t)}}function rr(e){const{notice:t,constructor:n,template:{$player:r,$video:o}}=e,i="art-auto-orientation",a="art-auto-orientation-fullscreen";let s=!1;function c(){const h=document.documentElement.clientWidth,u=document.documentElement.clientHeight;p(r,"width",`${u}px`),p(r,"height",`${h}px`),p(r,"transform-origin","0 0"),p(r,"transform",`rotate(90deg) translate(0, -${h}px)`),w(r,i),e.isRotate=!0,e.emit("resize")}function l(){p(r,"width",""),p(r,"height",""),p(r,"transform-origin",""),p(r,"transform",""),I(r,i),e.isRotate=!1,e.emit("resize")}function d(){const{videoWidth:h,videoHeight:u}=o,m=document.documentElement.clientWidth,f=document.documentElement.clientHeight;return h>u&&m<f||h<u&&m>f}return e.on("fullscreenWeb",h=>{if(h){if(d()){const u=Number(n.AUTO_ORIENTATION_TIME??0);setTimeout(()=>{e.fullscreenWeb&&!H(r,i)&&c()},u)}}else H(r,i)&&l()}),e.on("fullscreen",async h=>{const u=!!screen?.orientation?.lock;if(h){if(u&&d())try{const f=screen.orientation.type.startsWith("portrait")?"landscape":"portrait";await screen.orientation.lock(f),s=!0,w(r,a)}catch(m){s=!1,t.show=m}}else if(H(r,a)&&I(r,a),u&&s){try{screen.orientation.unlock()}catch{}s=!1}}),{name:"autoOrientation",get state(){return H(r,i)}}}function or(e){const{i18n:t,icons:n,storage:r,constructor:o,proxy:i,template:{$poster:a}}=e,s=e.layers.add({name:"auto-playback",html:`
            <div class="art-auto-playback-close"></div>
            <div class="art-auto-playback-last"></div>
            <div class="art-auto-playback-jump"></div>
        `}),c=A(".art-auto-playback-last",s),l=A(".art-auto-playback-jump",s),d=A(".art-auto-playback-close",s);g(d,n.close);let h=null;e.on("video:timeupdate",()=>{if(e.playing){const m=r.get("times")||{},f=Object.keys(m);f.length>o.AUTO_PLAYBACK_MAX&&delete m[f[0]],m[e.option.id||e.option.url]=e.currentTime,r.set("times",m)}});function u(){const f=(r.get("times")||{})[e.option.id||e.option.url];clearTimeout(h),p(s,"display","none"),f&&f>=o.AUTO_PLAYBACK_MIN&&(p(s,"display","flex"),c.textContent=`${t.get("Last Seen")} ${F(f)}`,l.textContent=t.get("Jump Play"),i(d,"click",()=>{p(s,"display","none")}),i(l,"click",()=>{e.seek=f,e.play(),p(a,"display","none"),p(s,"display","none")}),e.once("video:timeupdate",()=>{h=setTimeout(()=>{p(s,"display","none")},o.AUTO_PLAYBACK_TIMEOUT)}))}return e.on("ready",u),e.on("restart",u),{name:"auto-playback",get times(){return r.get("times")||{}},clear(){return r.del("times")},delete(m){const f=r.get("times")||{};return delete f[m],r.set("times",f),f}}}function ir(e){const{constructor:t,proxy:n,template:{$player:r,$video:o}}=e;let i=null,a=!1,s=1;const c=d=>{d.touches.length===1&&e.playing&&!e.isLock&&(i=setTimeout(()=>{a=!0,s=e.playbackRate,e.playbackRate=t.FAST_FORWARD_VALUE,w(r,"art-fast-forward")},t.FAST_FORWARD_TIME))},l=()=>{clearTimeout(i),a&&(a=!1,e.playbackRate=s,I(r,"art-fast-forward"))};return n(o,"touchstart",c),e.on("document:touchmove",l),e.on("document:touchend",l),{name:"fastForward",get state(){return H(r,"art-fast-forward")}}}function ar(e){const{layers:t,icons:n,template:{$player:r}}=e;function o(){return H(r,"art-lock")}function i(){w(r,"art-lock"),e.isLock=!0,e.emit("lock",!0)}function a(){I(r,"art-lock"),e.isLock=!1,e.emit("lock",!1)}return t.add({name:"lock",mounted(s){const c=g(s,n.lock),l=g(s,n.unlock);p(c,"display","none"),e.on("lock",d=>{d?(p(c,"display","inline-flex"),p(l,"display","none")):(p(c,"display","none"),p(l,"display","inline-flex"))})},click(){o()?a():i()}}),{name:"lock",get state(){return o()},set state(s){s?i():a()}}}function sr(e){return e.on("control",t=>{t?I(e.template.$player,"art-mini-progress-bar"):w(e.template.$player,"art-mini-progress-bar")}),{name:"mini-progress-bar"}}class lr{constructor(t){this.art=t,this.id=0;const{option:n}=t;n.miniProgressBar&&!n.isLive&&this.add(sr),n.lock&&M&&this.add(ar),n.autoPlayback&&!n.isLive&&this.add(or),n.autoOrientation&&M&&this.add(rr),n.fastForward&&M&&!n.isLive&&this.add(ir);for(let r=0;r<n.plugins.length;r++)this.add(n.plugins[r])}add(t){this.id+=1;const n=t.call(this.art,this.art);return n instanceof Promise?n.then(r=>this.next(t,r)):this.next(t,n)}next(t,n){const r=n&&n.name||t.name||`plugin${this.id}`;return V(!et(this,r),`Cannot add a plugin that already has the same name: ${r}`),v(this,r,{value:n}),this}}function cr(e){const{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,ASPECT_RATIO:o}}=e;function i(s){return s==="default"?t.get("Default"):s}function a(){const s=e.setting.find(`aspect-ratio-${e.aspectRatio}`);e.setting.check(s)}return{width:r,name:"aspect-ratio",html:t.get("Aspect Ratio"),icon:n.aspectRatio,tooltip:i(e.aspectRatio),selector:o.map(s=>({value:s,name:`aspect-ratio-${s}`,default:s===e.aspectRatio,html:i(s)})),onSelect(s){return e.aspectRatio=s.value,s.html},mounted:()=>{a(),e.on("aspectRatio",()=>a())}}}function dr(e){const{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,FLIP:o}}=e;function i(s){return t.get(ht(s))}function a(){const s=e.setting.find(`flip-${e.flip}`);e.setting.check(s)}return{width:r,name:"flip",html:t.get("Video Flip"),tooltip:i(e.flip),icon:n.flip,selector:o.map(s=>({value:s,name:`flip-${s}`,default:s===e.flip,html:i(s)})),onSelect(s){return e.flip=s.value,s.html},mounted:()=>{a(),e.on("flip",()=>a())}}}function pr(e){const{i18n:t,icons:n,constructor:{SETTING_ITEM_WIDTH:r,PLAYBACK_RATE:o}}=e;function i(s){return s===1?t.get("Normal"):s.toFixed(1)}function a(){const s=e.setting.find(`playback-rate-${e.playbackRate}`);e.setting.check(s)}return{width:r,name:"playback-rate",html:t.get("Play Speed"),tooltip:i(e.playbackRate),icon:n.playbackRate,selector:o.map(s=>({value:s,name:`playback-rate-${s}`,default:s===e.playbackRate,html:i(s)})),onSelect(s){return e.playbackRate=s.value,s.html},mounted:()=>{a(),e.on("video:ratechange",()=>a())}}}function hr(e){const{i18n:t,icons:n,constructor:r}=e;return{width:r.SETTING_ITEM_WIDTH,name:"subtitle-offset",html:t.get("Subtitle Offset"),icon:n.subtitle,tooltip:"0s",range:[0,-10,10,.1],onChange(o){return e.subtitleOffset=o.range[0],`${o.range[0]}s`},mounted:(o,i)=>{e.on("subtitleOffset",a=>{i.$range.value=a,i.tooltip=`${a}s`})}}}class ur extends j{constructor(t){super(t);const{option:n,controls:r,template:{$setting:o}}=t;this.name="setting",this.$parent=o,this.id=0,this.active=null,this.cache=new Map,this.option=[...this.builtin,...n.settings],n.setting&&(this.format(),this.render(),t.on("blur",()=>{this.show&&(this.show=!1,this.render())}),t.on("focus",i=>{const a=q(i,r.setting),s=q(i,this.$parent);this.show&&!a&&!s&&(this.show=!1,this.render())}),t.on("resize",()=>this.resize()))}get builtin(){const t=[],{option:n}=this.art;return n.playbackRate&&t.push(pr(this.art)),n.aspectRatio&&t.push(cr(this.art)),n.flip&&t.push(dr(this.art)),n.subtitleOffset&&t.push(hr(this.art)),t}traverse(t,n=this.option){for(let r=0;r<n.length;r++){const o=n[r];t(o),o.selector?.length&&this.traverse(t,o.selector)}}check(t){t&&(t.$parent.tooltip=t.html,this.traverse(n=>{n.default=n===t,n.default&&n.$item&&N(n.$item,"art-current")},t.$option),this.render(t.$parents))}format(t=this.option,n,r,o=[]){for(let i=0;i<t.length;i++){const a=t[i];if(a?.name?(V(!o.includes(a.name),`The [${a.name}] already exists in [setting]`),o.push(a.name)):a.name=`setting-${this.id++}`,!a.$formatted){v(a,"$parent",{get:()=>n}),v(a,"$parents",{get:()=>r}),v(a,"$option",{get:()=>t});const s=[];v(a,"$events",{get:()=>s}),v(a,"$formatted",{get:()=>!0})}this.format(a.selector||[],a,t,o)}this.option=t}find(t=""){let n=null;return this.traverse(r=>{r.name===t&&(n=r)}),n}resize(){const{controls:t,constructor:{SETTING_WIDTH:n,SETTING_ITEM_HEIGHT:r},template:{$player:o,$setting:i}}=this.art;if(t.setting&&this.show){const a=this.active[0]?.$parent?.width||n,{left:s,width:c}=Y(t.setting),{left:l,width:d}=Y(o),h=s-l+c/2-a/2,u=this.active===this.option?this.active.length*r:(this.active.length+1)*r;if(p(i,"height",`${u}px`),p(i,"width",`${a}px`),this.art.isRotate||M)return;h+a>d?(p(i,"left",null),p(i,"right",null)):(p(i,"left",`${h}px`),p(i,"right","auto"))}}inactivate(t){for(let n=0;n<t.$events.length;n++)this.art.events.remove(t.$events[n]);t.$events.length=0}remove(t){const n=this.find(t);V(n,`Can't find [${t}] in the [setting]`);const r=n.$option.indexOf(n);n.$option.splice(r,1),this.inactivate(n),n.$item&&dt(n.$item),this.render()}update(t){const n=this.find(t.name);return n?(this.inactivate(n),Object.assign(n,t),this.format(),this.createItem(n,!0),this.render(),n):this.add(t)}add(t,n=this.option){return n.push(t),this.format(),this.createItem(t),this.render(),t}createHeader(t){if(!this.cache.has(t.$option))return;const n=this.cache.get(t.$option),{proxy:r,icons:{arrowLeft:o},constructor:{SETTING_ITEM_HEIGHT:i}}=this.art,a=S("div");p(a,"height",`${i}px`),w(a,"art-setting-item"),w(a,"art-setting-item-back");const s=g(a,'<div class="art-setting-item-left"></div>'),c=S("div");w(c,"art-setting-item-left-icon"),g(c,o),g(s,c),g(s,t.$parent.html);const l=r(a,"click",()=>this.render(t.$parents));t.$parent.$events.push(l),g(n,a)}createItem(t,n=!1){if(!this.cache.has(t.$option))return;const r=this.cache.get(t.$option),o=t.$item;let i="selector";et(t,"switch")&&(i="switch"),et(t,"range")&&(i="range"),et(t,"onClick")&&(i="button");const{icons:a,proxy:s,constructor:c}=this.art,l=S("div");w(l,"art-setting-item"),p(l,"height",`${c.SETTING_ITEM_HEIGHT}px`),l.dataset.name=t.name||"",l.dataset.value=t.value||"";const d=g(l,'<div class="art-setting-item-left"></div>'),h=g(l,'<div class="art-setting-item-right"></div>'),u=S("div");switch(w(u,"art-setting-item-left-icon"),i){case"button":case"switch":case"range":g(u,t.icon||a.config);break;case"selector":t.selector?.length?g(u,t.icon||a.config):g(u,a.check);break}g(d,u),v(t,"$icon",{configurable:!0,get:()=>u}),v(t,"icon",{configurable:!0,get(){return u.innerHTML},set(y){u.innerHTML="",g(u,y)}});const m=S("div");w(m,"art-setting-item-left-text"),g(m,t.html||""),g(d,m),v(t,"$html",{configurable:!0,get:()=>m}),v(t,"html",{configurable:!0,get(){return m.innerHTML},set(y){m.innerHTML="",g(m,y)}});const f=S("div");switch(w(f,"art-setting-item-right-tooltip"),g(f,t.tooltip||""),g(h,f),v(t,"$tooltip",{configurable:!0,get:()=>f}),v(t,"tooltip",{configurable:!0,get(){return f.innerHTML},set(y){f.innerHTML="",g(f,y)}}),i){case"switch":{const y=S("div");w(y,"art-setting-item-right-icon");const b=g(y,a.switchOn),$=g(y,a.switchOff);p(t.switch?$:b,"display","none"),g(h,y),v(t,"$switch",{configurable:!0,get:()=>y});let C=t.switch;v(t,"switch",{configurable:!0,get:()=>C,set(L){C=L,L?(p($,"display","none"),p(b,"display",null)):(p($,"display",null),p(b,"display","none"))}});break}case"range":{const y=S("div");w(y,"art-setting-item-right-icon");const b=g(y,'<input type="range">');b.value=t.range[0],b.min=t.range[1],b.max=t.range[2],b.step=t.range[3],w(b,"art-setting-range"),g(h,y),v(t,"$range",{configurable:!0,get:()=>b});let $=[...t.range];v(t,"range",{configurable:!0,get:()=>$,set(C){$=[...C],b.value=C[0],b.min=C[1],b.max=C[2],b.step=C[3]}})}break;case"selector":if(t.selector?.length){const y=S("div");w(y,"art-setting-item-right-icon"),g(y,a.arrowRight),g(h,y)}break}switch(i){case"switch":{if(t.onSwitch){const y=s(l,"click",async b=>{t.switch=await t.onSwitch.call(this.art,t,l,b)});t.$events.push(y)}break}case"range":{if(t.$range){if(t.onRange){const y=s(t.$range,"change",async b=>{t.range[0]=t.$range.valueAsNumber,t.tooltip=await t.onRange.call(this.art,t,l,b)});t.$events.push(y)}if(t.onChange){const y=s(t.$range,"input",async b=>{t.range[0]=t.$range.valueAsNumber,t.tooltip=await t.onChange.call(this.art,t,l,b)});t.$events.push(y)}}break}case"selector":{const y=s(l,"click",async b=>{t.selector?.length?this.render(t.selector):(this.check(t),t.$parent.onSelect&&(t.$parent.tooltip=await t.$parent.onSelect.call(this.art,t,l,b)))});t.$events.push(y),t.default&&w(l,"art-current")}break;case"button":if(t.onClick){const y=s(l,"click",async b=>{t.tooltip=await t.onClick.call(this.art,t,l,b)});t.$events.push(y)}break}v(t,"$item",{configurable:!0,get:()=>l}),n?vt(l,o):g(r,l),t.mounted&&setTimeout(()=>t.mounted.call(this.art,t.$item,t),0)}render(t=this.option){if(this.active=t,this.cache.has(t)){const n=this.cache.get(t);N(n,"art-current")}else{const n=S("div");this.cache.set(t,n),w(n,"art-setting-panel"),g(this.$parent,n),N(n,"art-current"),t[0]?.$parent&&this.createHeader(t[0]);for(let r=0;r<t.length;r++)this.createItem(t[r])}this.resize()}}class fr{constructor(){this.name="artplayer_settings",this.settings={}}get(t){try{const n=JSON.parse(window.localStorage.getItem(this.name))||{};return t?n[t]:n}catch{return t?this.settings[t]:this.settings}}set(t,n){try{const r=Object.assign({},this.get(),{[t]:n});window.localStorage.setItem(this.name,JSON.stringify(r))}catch{this.settings[t]=n}}del(t){try{const n=this.get();delete n[t],window.localStorage.setItem(this.name,JSON.stringify(n))}catch{delete this.settings[t]}}clear(){try{window.localStorage.removeItem(this.name)}catch{this.settings={}}}}const Bt=`.art-video-player {
  --art-theme: #f00;
  --art-font-color: #fff;
